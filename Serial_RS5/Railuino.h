...
class TrackController {
	 ...
	 */
    TrackController(word hash, bool debug);
     ...
     * generated.
     */
    void init(word hash, bool debug, bool loopback);
     ...
     * reflects whether the call was successful.
     */
    bool setLocoDirection(word address, byte direction);

    /**
     * Toggles the direction of the given locomotive. This normally
     * includes a full stop.
     */
    bool toggleLocoDirection(word address);
     ...
     * whether the call was successful.
     */
    bool setLocoFunction(word address, byte function, byte power);
     ...
     * head/backlight.
     */
    bool toggleLocoFunction(word address, byte function);
     ...
     * whether the call was successful.
     */
    bool setAccessory(word address, byte position, byte power, word time);
     ...
     * successful.
     */
    bool setTurnout(word address, bool straight);
     ...
     */
    bool getLocoDirection(word address, byte *direction);
     ...
     */
    bool getLocoSpeed(word address, word *speed);
     ...
     */
    bool getLocoFunction(word address, byte function, byte *power);
     ...
     * to the function, but only 0 ("off") or 1 ("on").
     */
    bool getAccessory(word address, byte *position, byte *power);
     ...
     * some parameters.
     */
    bool getTurnout(word address, bool *straight);
     ...
     */
    bool getVersion(byte *high, byte *low); 
...
class TrackControllerInfrared {
     ...
     */
    bool sendMessage(word address, word command);
     ...
     */
    bool toggleLocoDirection(int loco);
     ...
     * the call was successful.
     */
    bool toggleLocoFunction(int loco, int function);
    
    /**
     * Switches a turnout. The return value reflects whether the call
     * was successful.
     */
    bool setTurnout(int turnout, bool straight);
