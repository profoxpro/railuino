...
namespace DesktopStation
{
    class MeterDrawing
    {
        ...
        public void DrawS88SensorDisplay(Graphics inCanvas, int[] inS88Flags,int[] inS88Latched, int inScaleRatio)
        {
            int i, j;
            int aDrawID;
            int aX, aY;
            ...
            for (i = 0; i < 16; i++)
            {
                ...
                for (j = 0; j < 16; j++)
                {
                    ...
                    if (((inS88Latched[i] >> j) & 0x01) == 1)
                    {
                        inCanvas.DrawString("L", aDrawFont, Brushes.Aquamarine, aX * inScaleRatio / 100, aY * inScaleRatio / 100);
                    }
        ...
        public void DrawBottomoBarS88Sensors(Graphics inCanvas, int[] inS88Flags, int[] inS88Latched, int inGroupNo, int inScaleRatio)
        {
            int j;
            int aDrawID;
            int aX, aY;
            ...
            for (j = 0; j < 16; j++)
            {
                ...
                if (((inS88Latched[inGroupNo] >> j) & 0x01) == 1)
                {
                    inCanvas.DrawString("L", aDrawFont, Brushes.Aquamarine, aX * inScaleRatio / 100, aY * inScaleRatio / 100);
                }
        ...
        public void DrawS88Sensor(Graphics inCanvas, int inX, int inY, bool inFlag, bool inLatch, int inPicIndex, int inScaleRatio)
        {
            ...
            if (inFlag == true)
            {
                if (inLatch == true)
                {
                    inCanvas.FillRectangle(Brushes.Red, inX + aX, inY + aY, 6 * inScaleRatio / 100, 6 * inScaleRatio / 100);
                }
                else
                {
            ...
            else
            {
                if (inLatch == true)
                {
                    inCanvas.FillRectangle(Brushes.Gray, inX + aX, inY + aY, 6 * inScaleRatio / 100, 6 * inScaleRatio / 100);
                }
                else
                {
