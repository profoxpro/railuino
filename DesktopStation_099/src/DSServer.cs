        ...
        public void Run()
        {
            ...
            // 要求URL確認 ＆ 応答内容生成
             ...
             if (mStatus == STATUS.CHECKING && 0 == pos)
             {
                 ...
                 {
                     //GETコマンド取得
                     aGETcmd = message.Substring(pos + 4, aPosEnd - 4 - pos);

                     aPosCmd = aGETcmd.IndexOf("?CMD=");

                     if (aPosCmd > 0)
                     {
                         String aCmd = aGETcmd.Substring(aPosCmd + 5, aGETcmd.Length - aPosCmd - 5);
                     ...
                     {
                         //aPosCmd = aGETcmd.IndexOf("css/");

                         String aCssExt = System.IO.Path.GetExtension(aGETcmd);
                         ...
                         if (aCssExt.Length > 0)
                         {
                             ...
                             //?が混じっていたら消す
                             int aQuestMark = aCssExt.IndexOf("?");

                             if (aQuestMark > 0)
                             {
                                 aCssExt = aCssExt.Substring(0, aQuestMark);
                                 aCssFile = aCssFile.Substring(0, aCssFile.IndexOf("?"));
                             }
                             ...
                             switch (aCssExt.ToLower())
                             {
                                 case ".css":
                                     ...
                                     if (File.Exists(ExePath + "\\webapp\\" + aCssFile) == true)
                                     {
                                         message = System.IO.File.ReadAllText(ExePath + "\\webapp\\" + aCssFile);
                                     }
                                     break;
                                 case ".js":
                                 ...
                                 case ".woff":
                                 case ".woff2": 
                                     aContentType = "application/font-woff";
                                     aBinaryRead = 1;
                                     break;

                                 case ".ttf":
                                     aContentType = "application/x-font-ttf";
                                     aBinaryRead = 1;
                                     break;
                                 case ".otf":
                                     aContentType = "application/x-font-otf";
                                     aBinaryRead = 1;
                                     break;
                                 case ".svgf":
                                     ...
                                     break;
                                 case ".eot":
                                     aContentType = "application/vnd.ms-fontobject";
                                     aBinaryRead = 1;
                                     break;
                                 case ".ico":
            ...
            /* 応答 */
             ...
             if (aBinaryRead == 1)
             {
                 ...
                 if (File.Exists(ExePath + "\\webapp\\" + aCssFile) == true)
                 {
                     FileStream aFs = new FileStream(ExePath + "\\webapp\\" + aCssFile, System.IO.FileMode.Open, System.IO.FileAccess.Read);
