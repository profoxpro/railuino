...
namespace DesktopStation
{
    ...
    {
        //https://takachan.hatenablog.com/entry/2017/12/05/002428
        public static void ChangeBit(ref int src, int bit, int val /* true = 1 / false = 0 */)
        {
            int mask = 1 << bit;
            src = (val == 1) ? src | mask : src & ~mask;
        }
