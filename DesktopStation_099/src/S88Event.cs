...
namespace DesktopStation
{
    ...
    public class S88Event
    {
        ...
        private setS88Latch_delegate setS88Latch;
        ...
        public S88Event(RailuinoSerial inSerialCmd, getScriptValue_delegate inGetScriptValue, setScriptValues_delegate inSetScriptValue, 
            ...
            getS88Value_delegate inGetS88Value, checkRoute_delegate inCheckRoute, setRoute_delegate inSetRoute, getAccValue_delegate inGetAccItem, setS88Latch_delegate inSetS88Latch)
        {
            EventName = "";
            mSensorAddress = 0;
            mLocIndex = -1;
        ...
        private bool ProcessScript(ScriptData inData)
        {
            ...
            if (inData.mCommand == Program.SCRIPTCMD_LATCH)
            {
                /* S88ラッチ処理 */
                ...
                if (inData.mParam1 != "")
                {
                    ...
                    setS88Latch(int.Parse(inData.mParam1), int.Parse(inData.mParam2), inData.mParam3);
                ...
                {
                    /* ログ */
                    writeS88ProcessLog(EventName, getTriggerText(), lineNo, inData.mCommand + "(MISS ADDRESS)");
                }
            }
    ...
    public class S88EventManager
    {
        ...
        public S88EventManager(RailuinoSerial inSerialCmd, UpdateLocList_delegate inUpdateLocList, UpdateAccList_delegate inUpdateAccList, SetS88RunText_delegate inSetS88RunText, 
            runFile_delegate inRunFile, setTransitionSpeed_delegate inSetTransitionSpeed, getLocItemFromIndex_delegate inGetLocItemFromIndex,
            checkRoute_delegate inCheckRoute, setRoute_delegate inSetRoute, getAccValue_delegate inGetAccItem, setS88Latch_delegate inSetS88Latch)
        {
            int i;
            ...
            for (i = 0; i < Program.S88EVENT_MAX; i++)
            {
                mEvents[i] = new S88Event(inSerialCmd, GetScriptValues, setScriptValues, inUpdateLocList, inUpdateAccList, writeS88ProcessLog, inRunFile, inSetTransitionSpeed, inGetLocItemFromIndex, GetS88Values, inCheckRoute, inSetRoute, inGetAccItem, inSetS88Latch);
            }
        ...
        /// S88値取得
        /// </summary>
        /// <param name="inNo">S88番号(1-256)</param>
        /// 
        ...
        public bool LoadFromFile(String inFilename)
        {
            ...
            if (File.Exists(inFilename))
            {
                ...
                int aLength = aTempCfg.Events.Length;

                if (aLength > Program.S88EVENT_MAX)
                {
                    aLength = Program.S88EVENT_MAX;
                }
